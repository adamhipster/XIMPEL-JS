// ImageNew
// The ImageNew object implements a media type for XIMPEL to use. This media type is one of the core media types that ship with
...
//
// Notes:
// - The ImageNew object definition is added to the: ximpel.mediaTypeDefinitions namespace, but this is not required, it
...
//   will call the mediaPlay(), mediaPause() and mediaStop() methods that we implement in this ImageNew object.
...
//   object which this ImageNew object can throw so that XIMPEL can listen for the event and act upon the error).
...
ximpel.mediaTypeDefinitions.ImageNew = function( customElements, customAttributes, $parentElement, player ){
...
ximpel.mediaTypeDefinitions.ImageNew.prototype = new ximpel.MediaType();
ximpel.mediaTypeDefinitions.ImageNew.prototype.STATE_PLAYING = 'state_image_playing';
ximpel.mediaTypeDefinitions.ImageNew.prototype.STATE_PAUSED = 'state_image_paused';
ximpel.mediaTypeDefinitions.ImageNew.prototype.STATE_STOPPED = 'state_image_stopped';
...
ximpel.mediaTypeDefinitions.ImageNew.prototype.mediaPlay = function(){
	...
	this.$image.on('error', function(){
		...
		ximpel.warn("ImageNew.mediaPreload(): failed to preload image '" + $image[0].src + "'.");
		deferred.reject();
	});
...
ximpel.mediaTypeDefinitions.ImageNew.prototype.resumePlayback = function(){
	// Indicate that the media item is in a playing state now.
	this.state = this.STATE_PLAYING;
}
...
ximpel.mediaTypeDefinitions.ImageNew.prototype.mediaPause = function(){
...
ximpel.mediaTypeDefinitions.ImageNew.prototype.mediaStop = function(){
...
ximpel.mediaTypeDefinitions.ImageNew.prototype.mediaIsPlaying = function(){
...
ximpel.mediaTypeDefinitions.ImageNew.prototype.mediaIsPaused = function(){
...
ximpel.mediaTypeDefinitions.ImageNew.prototype.mediaIsStopped = function(){
...
ximpel.mediaTypeDefinitions.ImageNew.prototype.calculateImageNewDetails = function(){
...
var mediaTypeRegistrationObject = new ximpel.MediaTypeRegistration( 
	'image_new', 							// = the media type ID (and also the tagname used in the playlist)
	ximpel.mediaTypeDefinitions.ImageNew, 	// a pointer to the constructor function to create instances of the media type.
	{
